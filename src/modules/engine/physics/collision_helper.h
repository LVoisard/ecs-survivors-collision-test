...
namespace physics {
    ...
    static void correct_position(flecs::entity &a, const Collider &a_col, CollisionInfo &a_info,
                                  const Collider &b_col, Vector2 overlap) {
        const core::Position2D &a_pos = *(a.get<core::Position2D>());
        ...
        a.get_mut<core::Position2D>()->value = {a_pos.value - overlap * a_move_ratio});
    }
    ...
    static bool handle_circle_rec_collision(flecs::entity &a, const Collider &a_col, CollisionInfo &a_info,
        ...
        Vector2 overlap = collide_circle_rec(circle_col, *(a.get_mut<core::Position2D>()), a_info, b_col,
                                             *(b.get_mut<core::Position2D>()), b_info);
